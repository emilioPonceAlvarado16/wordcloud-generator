  ...
  return (
    <>
      ...
      <div className='container col-10 justify-content-center' style={{ paddingTop: "2%" }}>
        <h2 style={{ fontWeight: "bold" }}>WEBSITE PRIVACY POLICY </h2>

        <h3 >https://freewordcloud.netlify.app/</h3>
        <br />
        <p>  <h3 style={bl}>I. PRIVACY POLICY AND DATA PROTECTION</h3>
        ...
        <h4 style={bl}>Laws incorporated in this privacy policy</h4>
        ...
        <h3 style={bl}>Identity of the person responsible for the processing of personal data</h3>
        <p>The person responsible for processing the personal data collected inFree WordCloud Online is: Isaias Ponce Alvarado - Telematics Engineer
        </p>
        <h3 style={bl}>Registration of Personal Data.</h3>
        ...
        <h3 style={bl}>Categories of personal data</h3>
        <p>The categories of data that are processed in Free WordCloud OnlineThey are only identifying data. Under no circumstances are special categories of personal data processed within the meaning of Article 9 of the GDPR.</p>
        <h3 style={bl}>Legal basis for the processing of personal data</h3>
        <p>The legal basis for the processing of personal data is consent.Free WordCloud Onlineundertakes to obtain the express and verifiable consent of the User for the processing of their personal data for one or more specific purposes.
