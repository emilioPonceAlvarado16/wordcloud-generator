...
export default function Terms() {
  ...
  return (
    <>
      ...
      <h2 style={bl}>LEGAL NOTICE AND GENERAL CONDITIONS OF USE</h2>
      <h3 >https://freewordcloud.netlify.app</h3>
      <br/>
      <h2 style={bl}>I. GENERAL INFORMATION</h2>
      <p>In compliance with the duty of information provided in Law 34/2002 on Services of the Information Society and Electronic Commerce (LSSI-CE) of July 11, the following general information data of this website are provided below :

        The ownership of this website,https://freewordcloud.netlify.app, (hereinafter, Website) is held by:Isaias Ponce</p>
      <h2  style={bl}>II. GENERAL TERMS AND CONDITIONS OF USE</h2>
      <h3 style={bl}>The object of the conditions: The Website</h3>
      ...
      <p>Free WordCloud online by itself or as an assignee, is the owner of all the intellectual and industrial property rights of the Website, as well as the elements contained therein (by way of example and not exhaustive, images, sound, audio, video, software or texts , trademarks or logos, color combinations, structure and design, selection of materials used, computer programs necessary for its operation, access and use, etc.). They will, therefore, be works protected as intellectual property by the Spanish legal system, being applicable to them both the Spanish and community regulations in this field, as well as the international treaties related to the matter and signed by Spain.
...
In the event that the User or third party considers that any of the Contents of the Website supposes a violation of the rights of protection of intellectual property, they must immediately notifyFree WordCloud onlinethrough the contact information in the GENERAL INFORMATION section of this Legal Notice and General Conditions of Use.</p>
    ...
    <h3  style={bl}>SAW. LEGAL ACTIONS, APPLICABLE LEGISLATION AND JURISDICTION</h3>
    <p >Free WordCloud online reserves the right to present civil or criminal actions that it deems necessary for the improper use of the Website and Contents, or for the breach of these Conditions.
